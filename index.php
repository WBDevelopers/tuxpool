	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
						...
						<div class="fslider" data-arrows="false">
							<div class="flexslider">
								<div class="slider-wrap">
									<div class="slide">
										<a href="#">
											<img src="images/tuxPool_images/banner1.jpg" alt="Shop Image">
										</a>
									</div>
									<div class="slide">
										<a href="#">
											<img src="images/tuxPool_images/banner2.jpg" alt="Shop Image">
										</a>
									</div>
									<div class="slide">
										<a href="#">
											<img src="images/tuxPool_images/banner3.jpg" alt="Shop Image">
										</a>
									</div>
									<div class="slide">
										<a href="#">
											<img src="images/tuxPool_images/banner4.jpg" alt="Shop Image">
										</a>
									</div>
									<div class="slide">
										<a href="#">
											<img src="images/tuxPool_images/banner5.jpg" alt="Shop Image">
										</a>
									</div>
								</div>
							</div>
					...
					<div class="col_one_third bottommargin-lg col_last">
						...
						<div class="col_full bottommargin-sm">
							<a href="#"><img src="images/tuxPool_images/banner-side1.jpg" alt="Image"></a>
						</div>

						<div class="col_full nobottommargin">
							<a href="#"><img src="images/tuxPool_images/banner-side2.jpg" alt="Image"></a>
						</div>
				...
				<div class="promo parallax promo-full bottommargin-lg" style="background-image: url('images/tuxPool_images/parallax/4.jpg');" data-stellar-background-ratio="0.4">
					<div class="container clearfix">
						<h3>Get <span>Free Delivery</span> on orders of 5000 INR or more. Give us a call: <span>09453002238</span></h3>
						<span>Sale available on selected Brands that include Appliance Controls, Brass Fittings, Compressor, Condensers &amp; Copper Fittings.</span>
				...
				<div class="container clearfix">
					...
					<div class="col_one_third bottommargin-lg">
						<div class="feature-box center media-box fbox-bg">
							<div class="fbox-media">
								<img src="images/tuxPool_images/compressor1.jpg" alt="Image">
							</div>
							<div class="fbox-desc">
								<h3>Compressor<span class="subtitle">Flat 50% Off*</span></h3>
					...
					<div class="col_one_third bottommargin-lg">
						<div class="feature-box center media-box fbox-bg">
							<div class="fbox-media">
								<img src="images/tuxPool_images/compactCondenser1.jpg" alt="Image">
							</div>
							<div class="fbox-desc">
								<h3>Latest Product Arrivals<span class="subtitle">New Designs Available</span></h3>
					...
					<div class="col_one_third bottommargin-lg col_last">
						<div class="feature-box center media-box fbox-bg">
							<div class="fbox-media">
								<img src="images/tuxPool_images/askExpert.jpg" alt="Image">
							</div>
							<div class="fbox-desc">
								<h3>Doubts ?<span class="subtitle">Get Tips from Experts</span></h3>
								<p><a href="#" class="btn btn-default">Browse FAQ's</a></p>
							</div>
						</div>
					</div>
